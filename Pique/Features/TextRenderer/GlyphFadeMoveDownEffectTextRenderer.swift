...
struct GlyphFadeMoveDownEffectTextRenderer: TextRenderer, Animatable {
    ...
    func draw(layout: Text.Layout, in ctx: inout GraphicsContext) {
        let elements = layout.flattenedRunSlices
...
struct GlyphFadeMoveDownEffectTextTransition: Transition {
    ...
    func body(content: Content, phase: TransitionPhase) -> some View {
        ...
        let renderer = GlyphFadeMoveDownEffectTextRenderer(elapsedTime: elapsedTime, totalDuration: duration)
...
extension Transition where Self == GlyphFadeMoveDownEffectTextTransition {
    static var glyphFadeMoveDown: Self { GlyphFadeMoveDownEffectTextTransition() }
}
